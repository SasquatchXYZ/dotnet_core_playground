...
namespace FunWithCSharpAsync
{
    class Program
    {
        ...
        private static async Task MultiAwaits()
        {
        ...
        private static async Task<string> MethodWithTryCatch()
        {
            try
            {
                // Do some work
        ...
        private static async Task MethodWithProblems(int firstParam, int secondParam)
        {
        ...
        private static async Task MethodWithProblemsFixed(int firstParam, int secondParam)
        {
            Console.WriteLine("Enter");
            if (secondParam < 0)
            {
        ...
        private static async ValueTask<int> ReturnAnInt()
        {
